...
class mainState extends Phaser.State {
    ...
    private coin:Phaser.Sprite;
    private coin2:Phaser.Sprite;
    private coin3:Phaser.Sprite;
    private coin4:Phaser.Sprite;
    private coin5:Phaser.Sprite;
    private coin6:Phaser.Sprite;
    private redCoin:Phaser.Sprite;
    ...
    //fondo
    private bordes:Phaser.TilemapLayer;
    private map:Phaser.Tilemap;

    private contador:number;
    private puntos: Phaser.Text;
    ...
    private muerte(ufo:Phaser.Sprite, redCoin:Phaser.Sprite){
        this.game.state.restart()
    }


    private cogerMoneda(ufo:Phaser.Sprite, coin:Phaser.Sprite, redCoin:Phaser.Sprite) {
